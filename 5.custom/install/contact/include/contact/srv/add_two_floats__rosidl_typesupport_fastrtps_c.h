...
#ifndef CONTACT__SRV__ADD_TWO_FLOATS__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
#define CONTACT__SRV__ADD_TWO_FLOATS__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
...
#endif  // CONTACT__SRV__ADD_TWO_FLOATS__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_

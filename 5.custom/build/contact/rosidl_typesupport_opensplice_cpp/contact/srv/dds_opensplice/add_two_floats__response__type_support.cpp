...
using __ros_msg_type = contact::srv::AddTwoFloats_Response;

static contact::srv::dds_::AddTwoFloats_Response_TypeSupport __type_support;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_contact
const char *
register_type__AddTwoFloats_Response(
...
ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_contact
const char *
publish__AddTwoFloats_Response(

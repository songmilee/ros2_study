...
#ifndef CONTACT__SRV__ADD_TWO_FLOATS__RESPONSE__TYPE_SUPPORT_H_
#define CONTACT__SRV__ADD_TWO_FLOATS__RESPONSE__TYPE_SUPPORT_H_
...
#endif  // CONTACT__SRV__ADD_TWO_FLOATS__RESPONSE__TYPE_SUPPORT_H_

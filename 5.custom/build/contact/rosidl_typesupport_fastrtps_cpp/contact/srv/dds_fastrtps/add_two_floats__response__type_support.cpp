...
{
  auto typed_message =
    static_cast<const contact::srv::AddTwoFloats_Response *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<contact::srv::AddTwoFloats_Response *>(
    untyped_ros_message);
...
{
  return max_serialized_size_AddTwoFloats_Response(full_bounded, 0);
}
